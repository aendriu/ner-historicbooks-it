...
_LABEL_BLACKLIST = {
    "FANT": {
        "cavallo", "cavalli", "bestia", "bestie", "leone", "leoni", "cane", "cani",
        "lupo", "lupi", "gatto", "gatti", "serpente", "serpenti", "uccello", "uccelli",
        "pesce", "pesci", "aquila", "colomba", "cervo", "cinghiale", "toro", "asino",
        "bue", "pecora", "capra", "porco", "sparviero", "falcone", "lepre",
        "foco", "fuoco", "fiamma", "fiamme", "luna", "sole", "stella", "stelle",
        "fiore", "fiori", "rosa", "giglio", "albero", "bosco", "selva",
        "montagna", "fiume", "mare", "terra", "cielo", "vento",
        "pane", "vino", "acqua", "cibo", "carne", "latte",
        "fanciullo", "fanciulla", "donzella", "donna", "uomo", "uom",
        "ragazzo", "ragazza", "bambino", "bambina",
        "spada", "lancia", "scudo", "elmo", "corazza", "armatura",
        "corno", "arco", "freccia", "pugnale",
        "nave", "barca", "torre", "ponte", "porta", "muro", "mura",
        "casa", "chiesa", "convento", "palazzo", "castello", "fortezza",
        "margarita", "perla", "corona", "anello", "veste", "manto",
        "mostro", "mostri", "ombra", "ombre", "fantasma",
        "figliuolo", "figliuola", "demonio", "grame", "parenti",
    },
    "REL": {
        "padre", "madre", "fratello", "sorella", "figlio", "figlia",
        "figliuolo", "figliuola", "marito", "moglie", "sposa", "sposo",
        "zio", "zia", "nonno", "nonna", "nipote", "cugino", "cugina",
        "cognato", "cognata", "suocero", "suocera", "genero", "nuora",
        "amico", "amica", "compagno", "compagna", "rivale", "alleato",
        "consorte", "erede", "confidente", "segretario", "protettore",
        "discepolo", "allievo", "maestro", "donna", "signore", "signora",
        "parenti", "amante", "servo", "serva", "fanciullo", "fanciulla", "donzella",
        "figliuoli", "figliuole", "figli", "figlie", "fratelli", "sorelle", "mariti", "mogli",
    },
    "PER": {
        "Laonde", "Onde", "Pertanto", "Nondimeno", "Appresso",
        "Indi", "Quivi", "Imperocché", "Conciossiachè", "Perocché",
        "Avvegnaché", "Eziandio", "Altresì", "Viepiù", "Poscia",
        "Dappoiché", "Tostochè",
        "Einaudi", "Laterza", "Mondadori", "Feltrinelli", "Gius", "Gius.",
        "iorgio", "iorgio Vasari",
    },
    "TIT": set(),
}

_LABEL_BLACKLIST_LOWER = {
    label: {v.lower() for v in values}
    for label, values in _LABEL_BLACKLIST.items()
}
...
def _valid_entity(label: str, text: str, score: float) -> bool:
    ...
    blacklist = _LABEL_BLACKLIST.get(label, set())
    blacklist_lower = _LABEL_BLACKLIST_LOWER.get(label, set())
    if blacklist:
        text_lower = text.lower().strip()
        text_stripped = text.strip()
        if text_lower in blacklist_lower or text_stripped in blacklist:
            return False
